...
class FolderWidget : AppWidgetProvider() {
    ...
    override fun onReceive(ctx: Context, intent: Intent) {
        ...
        if (intent.action=="com.mydev.superwidget.APP_LAUNCH") {
            ...
            ctx.packageManager.getLaunchIntentForPackage(pkg)?.let{it.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);ctx.startActivity(it)}
        }
    }
